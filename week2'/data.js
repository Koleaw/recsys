 ...
 * Globals: movies, ratings; functions: loadData(), parseItemData(), parseRatingData().
 */
'use strict';

console.log('[data.js v7] loaded');
...
async function loadData() {
  ...
  try {
    ...
    // fetch with no-store to avoid CDN cache
    ...
    // Пробросим ошибку, чтобы инициализация наверху знала, что всё плохо
    throw err;
  }
}

/** Parse u.item (19 flags at end: unknown + 18 named) */
